...
public class SortAdapter extends RecyclerView.Adapter<SortAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final SortAdapter.ViewHolder holder, final int position) {
        ...
        if (position == getPositionForSection(section)) {
            ...
            holder.tvTag.setText(mData.get(position).letters);
        } else {
        ...
        holder.tvName.setText(this.mData.get(position).name);
	    
	    if(mData.get(position).type.equals("1")){
		    holder.tvName.setTextColor(ContextCompat.getColor(mContext,R.color.color_card_ok));
	    }else{
		    holder.tvName.setTextColor(ContextCompat.getColor(mContext,R.color.grayColor_main));
	    }
