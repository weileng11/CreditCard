...
import app.card.view.KmWebView;
...
public class ActWeb extends BaseTitleActivity
{
	...
	protected void onCreate(@Nullable Bundle bundle){
		...
		mWeb.setWebChromeClient(new WebChromeClient()
		{
			...
			//@Override
			public void openFileChooser(final ValueCallback<Uri> callback, String type,
					String capture){
				String[] types={type};
			...
			@Override
			public boolean onShowFileChooser(WebView web, ValueCallback<Uri[]> callback,
					final FileChooserParams params){
		...
		url+="&token="+SharedPreferencesUtils.getString(App.get(), "token", "");
		mWeb.loadUrl(url);
		//setLeftText("关闭");
		//setRightText("返回");
	}
	...
	public void onBackPressed(){
		...
		else new AlertDialog.Builder(getContext()).setMessage("关闭当前页面？")
				.setCancelable(false)
