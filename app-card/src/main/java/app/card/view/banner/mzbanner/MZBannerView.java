package app.card.view.banner.mzbanner;
...
import app.card.view.banner.mzbanner.transformer.CoverModeTransformer;
import app.card.view.banner.mzbanner.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
	 ...
	 */
	public void setPages(List<T> datas,int position,MZHolderCreator mzHolderCreator){
		...
		mAdapter.setUpViewViewPager(mViewPager,position);
	...
	public static class  MZPagerAdapter<T> extends PagerAdapter{
		 ...
		 * @param viewPager
		 */
		public void setUpViewViewPager(ViewPager viewPager,int position){
			mViewPager = viewPager;
			mViewPager.setAdapter(this);
			mViewPager.getAdapter().notifyDataSetChanged();
			//int currentItem = canLoop ? getStartSelectItem():0;
			//设置当前选中的Item currentItem
