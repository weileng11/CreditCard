...
public class PlanDateSetPop
{
	...
	public List<PlanTime> mlist;
	public String mTitle;
	//选中的item
	public PlanTime selectStr;
	
	public interface CommonSetListenter
	{
		void selectDataOk(PlanTime content);
	}
	
	public PlanDateSetPop(Activity activity, List<PlanTime> list,
			CommonSetListenter commonSetListenter){
		this.mActivity=activity;
		this.mlist=list;
		this.mHeadFmListenter=commonSetListenter;
		initView();
	}
	...
	private void setOnPopupViewClick(View view){
		...
		txvOk.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v){
				if(null==selectStr){
					ToastUtils.showToastLong(mActivity, "请选择日期");
				}else{
					popupWindow.dismiss();
	...
	class CommPopAdapter extends QuickAdapter<PlanTime>
	{
		...
		@Override
		protected void convert(QuickHolder helper, PlanTime item){
			if(item==null) return;
			helper.setText(R.id.txv_pop_content, item.monthDay);
